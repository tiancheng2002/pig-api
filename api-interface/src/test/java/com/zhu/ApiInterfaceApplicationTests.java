...
import com.zhu.modal.entity.Area;
import com.zhu.modal.entity.City;
import com.zhu.modal.entity.Street;
...
class ApiInterfaceApplicationTests {
    ...
    @Test
    void contextLoads() {
        String result = apiClient.getNameByGet("zhu");
        User user = new User();
...
//        FileInputStream fileInputStream = new FileInputStream(new File("D:\\新建文件夹\\Project\\springboot-api\\地区数据\\areas.json"));
    ...
    @Test
    void test3(){
        String jsonString = "[{\"code\":23,\"name\":\"黑龙江省\"},{\"code\":32,\"name\":\"江苏省\"},{\"code\":33,\"name\":\"浙江省\"},{\"code\":36,\"name\":\"江西省\"}]";
        Object list = JSONUtil.parse(jsonString);
        System.out.println(list);
//        AreaQueryRequest area = new AreaQueryRequest();
//        area.setProvinceCode(11L);
//        QueryWrapper<Area> queryData = QueryUtils.getQueryData(area, Area.class);
//        List<Area> list = areaService.list(queryData);
//        for (Area areaData : list) {
//            System.out.println(areaData);
//        }
    }

    @Test
    public void convertClass() throws ClassNotFoundException {
        Class<?> regionClass = Class.forName("com.zhu.modal.entity.Street");
//        Class<String> regionClass = ClassUtil.getClass("street");
//        Class<?> regionClass = ClassUtils.getClass("com.zhu.model.entity.street");
//        Class<?> province = RegionEnums.getEnumByValue("province").getText();
        System.out.println();
    }
    ...
    public void testProvince(){
        ...
        regionRequest.setName("江");
        regionRequest.setRegionEnums(RegionEnums.REGION_PROVINCE);
        RegionResponse regionResponse = apiClient.regionData(regionRequest);
    ...
    public void ipTest(){
        ...
        addressRequest.setIp("116.148.184.140");
        AddressResponse addressResponse = apiClient.IpAddressDetail(addressRequest);
        System.out.println(addressResponse.getData());
        AddressResponse addressResponse1 = BeanCopeUtils.copyBean(addressResponse.getData(), AddressResponse.class);
    ...
    public void convertTest(){
        ...
        map.put("city","宁波");
        map.put("pro","浙江省");
        AddressResponse addressResponse = BeanCopeUtils.convertMapToBean(map, AddressResponse.class);
        System.out.println(addressResponse);
    }

    @Test
    public void random(){
        HttpResponse response = HttpRequest.get("https://api.suyanw.cn/api/comic").execute();
